...
SCRIPTS: tuple[ScriptSpec, ...] = (
    ...
    ScriptSpec(
        ...
        args=(
            ...
            ArgSpec("train.policy_obs", "choice", "Training observation",
                    default="bps", choices=("bps", "legacy_tag")),
            ArgSpec("train.run_name", "str", "Isolated run subdirectory"),
    ...
    ScriptSpec(
        ...
        args=(
            ...
            ArgSpec("distill.teacher_obs", "choice", "Teacher obs view",
                    default="identical",
                    choices=("identical", "current", "privileged", "legacy_tag")),
    ...
    ScriptSpec(
        ...
        args=(
            ...
            ArgSpec("teacher_obs", "choice", "Migration teacher view",
                    default="null", choices=("null", "legacy_tag")),
            ArgSpec("seed", "int", "Seed"),
    ...
    ScriptSpec(
        ...
        args=(
            ...
            ArgSpec("--complete-setup", "flag",
                    "Interactive remount workflow through sim XML update"),
            ArgSpec("--family", "choice", "Table marker family", default="apriltag",
                    choices=("apriltag", "aruco")),
            ArgSpec("--mount-frames", "int", "Anchored frames per sim mount",
                    default="100"),
        ),
        resources=(Resource.CAMERA,),
    ),
